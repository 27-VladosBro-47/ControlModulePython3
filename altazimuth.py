...
class AltAzimuth:
    ...
    servoUp = 8, servoDown = 7, windowWidth = 640, windowHeight = 480, calibration = 0.35):
        self.isWork = isWork
    ...
    def mainFunction(self):
        self.setAngle(self.servoUp,self.posVertical-1,0.1)
        self.setAngle(self.servoUp,self.posVertical,0.1)
        time.sleep(0.1)
        self.setAngle(self.servoDown,self.posHorizontal-1,0.1)
